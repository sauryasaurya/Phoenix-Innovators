    ...
    $.extend(SmartCart.prototype, {
        ...
        _setToolbar: function () {
            ...
            if (this.options.toolbarSettings.showCheckoutButton) {
                ...
                switch (this.options.toolbarSettings.checkoutButtonStyle) {
                    ...
                    case 'image':
                        ...
                        break;
                    default:
                        btnCheckout = '<button class="btn btn-info sc-cart-checkout float-left" type="button">' + this.options.lang.checkout + '</button> ';
                        break;
                }
            ...
            if (this.options.toolbarSettings.showClearButton) {
                var btnClear = $('<button class="btn btn-danger sc-cart-clear float-right" type="button">').text(this.options.lang.clear);
